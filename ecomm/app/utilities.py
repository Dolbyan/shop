    ...
    def consume_messages(self, topic, group_id, process_message_function):
        ...
        while True:
            ...
            try:
                ...
                print("Otrzymana wiadomość:", message_content)
                message_json = json.loads(message_content)
                print("Po pierwszym json.loads:", message_json)
                print("Typ message_json:", type(message_json))
                process_message_function(message_json)
            except json.JSONDecodeError as e:
                print(f"Błąd dekodowania JSON: {e}")
                print(f"Treść wiadomości: {message_content}")
                continue